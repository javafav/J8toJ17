...
public class Meal {
    ...
    public class Item {
        ...
        @Override
        public String toString() {
            return "%10s%15s $%.0f".formatted(type, name, getPrice(price, conversionRate));
        }
        ...
        private void addToppings(String... selectedToppings){
            for(String selectedTopping : selectedToppings){
               try {
                   ...
                   System.out.println("Sorry! no topping found for " + selectedTopping);
               }
